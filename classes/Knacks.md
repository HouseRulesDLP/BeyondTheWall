...
## %%Charger%%
**Charger:** If you perform the [charge maneuver](Battle_Maneuvers.md#charge), add +2 to your damage rolls.

## %%Cleave%%
**Cleave:** Immediately after one of your melee attacks drops a foe to 0 hit points, you may make another attack. If you have movement remaining, you may move between attacks.
...
## %%Deft Fingers%%
**Deft Fingers:** You gain [Advantage](Glossary.md#Advantage) on [Lockpick](Skills.md#lockpick), [Legerdemain](Skills.md#Legerdemain) and [Trap Handling](Skills.md#trap%20handling) checks.

## %%Distracting Defense%%
**Distracting Defense:** You may add your CHA bonus to your AC so long as you are not wearing medium or heavy armor.  This knack may not be combined with [Intelligent Defense](#Intelligent%20Defense).

## %%Exploit Weakness%%
**Exploit Weakness:** Increase your [Critical Hit](Glossary.md#critical%20hit) range by 1 (i.e. from 20 to 19).  This knack may be taken up to 3 times.

## %%Fleet%%
**Fleet:** Gain +1 Initiative, +5 ft movement and +1 AC vs [Parting Shots](Combat.md#parting%20shots) so long as you are not wearing heavy armor.

## %%Intelligent Defense%%
**Intelligent Defense:** You may add your INT bonus to your AC so long as you are not wearing medium or heavy armor.  This knack may not be combined with [Distracting Defense](#Distracting%20Defense).

## %%Last Stand%%
**Last Stand:** You do not immediately fall [unconscious](Conditions.md#unconscious) when dropped to 0 HP.  Make a Doom Save each round vs a 12 Difficulty to remain conscious and fighting.  You must still follow all the normal [Death Pool](Countdown_Pools.md#death%20pool) rules.

## %%Light Footed%%
**Light Footed:** Gain +10ft movement and move at full speed with no penalty to [stealth](Skills.md#stealth) so long as you are not wearing medium or heavy armor.
...
## %%Poisoner%%
**Poisoner:** If you poison a target, that target has [Disadvantage](Glossary.md#Disadvantage) on their Saving Throw to resist the poison's effects. Additionally, you have [Advantage](Glossary.md#Advantage) on your own Saving Throws to resist poison.

## %%Protector%%
**Protector:** While you are in melee with a foe, any attacks that foe makes against a target other than you is done with [Disadvantage](Glossary.md#Disadvantage).

## %%Reckless%%
**Reckless:** For the remainder of the round, you have [Advantage](Glossary.md#Advantage) on all your melee attacks.  However, all attacks **against** also you have [Advantage](Glossary.md#Advantage) until the start of your next turn.
