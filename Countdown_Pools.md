...
## Death Pool
One special *Countdown Pool* is the **Death Pool**. A death pool is a number of 4-sided dice equal to the creature's Constitution Modifier plus its Wisdom Modifier; with a minimum pool size of 1. This is rolled at the end of each of the creature's [Combat Turns](Glossary.md#combat%20turn) and when the pool is empty, the creature expires.

Only PCs and special NPCs have Death Pools.  Minions, commoners and similar mundane NPCs immediately expire if a **Death Pool** would be called for.

## Countdown Pool Average Number of Rolls
The below table shows how many rolls *on average* it will take before the pool runs out of dice.
