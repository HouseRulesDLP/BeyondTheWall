...
- [Encumbrance](#Encumbrance)
	- [Readied Items](#Readied%20Items)
	- [Stowed Items](#Stowed%20Items)
	- [Excessive Encumbrance](#Excessive%20Encumbrance)
- [Coinage](#Coinage)
- [Quality](#Quality)
- [Rarity](#Rarity)
- [Haggling](#Haggling)
...
These limits represent the amount of gear a character can carry without penalty.  An extra 2 Readied Items or 4 Stowed Items (or fractions thereof), reduces a character's Movement by 5 feet and they take a -2 penalty on all Strength and Dexterity Checks.  Additionally, for every hour so encumbered, they must make a Constitution Check vs a Difficulty of 12 or gain a level of [Exhaustion](Conditions.md#exhaustion).  Going further beyond this limit; up to 4 Readied Items or 8 Stowed Items, reduces the character's movement to half, increases the Strength and Dexterity check penalties to -4 and increases the Exhaustion check difficulty to 15.
...
- **Impact**: On a Critical Hit, the target must make a Strength Check (difficulty = damage taken) or suffer the effects of a [Shove Maneuver](Battle_Maneuvers.md#shove).
- **Lance**: This weapon requires 2-hands when used on foot, but only 1 hand when mounted. Additionally, it does double damage on a mounted [Charge Maneuver](Battle_Maneuvers.md#charge).
...
- **Set**: This weapon may be set against a [charge](Battle_Maneuvers.md#charge), rolling double the normal damage dice if it hits a charging target.
- **Snare**: A large or smaller creature hit by this weapon is [Restrained](Conditions.md#restrained). A restrained creature may spend an Action to attempt a Dexterity Check vs a Difficulty equal to the Attack Roll total to escape.  Alternatively, a Difficulty 15 Strength Check may be attempted to break the ensnaring weapon.
...
## Armor
The armor list below should be considered as general categories of armor rather than a definitive list.  There are too many types of armor in both history and fantasy to create a truly exhaustive list and, instead, armor should be associated with its nearest category to determine its game mechanics.
...
- **Encumbering**: Reduces movement by 5ft (for Medium armor) or 10ft (for Heavy armor).  Also for every 1 minute of intense activity (such as combat), make a Constitution check vs difficulty 12 (Medium) or 15 (Heavy) or gain 1 level of [Exhaustion](Conditions.md#exhausted).
    ...
    <table border=2>
        <thead>
            <tr style="background-color:#708090;">
                ...
                <th id="category" style="text-align:center;">Category</th>
        ...
        <tbody>
            ...
            <tr style="background-color:#708090;">
	            <td colspan=7># Grants +3 AC with no armor, +2 with Light armor, +1 with Medium and +0 with Heavy.<br/>% Grants +4 AC with no armor, +3 with Light, +2 with Medium and +1 with Heavy.</td>
            </tr>
        </tbody>
    </table>
</div>
    ...
    <table border=2>
        ...
        <tbody>
            <tr>
                ...
                <td style="text-align:right;">50sp</td>
                <td style="text-align:center;">1</td>
                <td style="text-align:left;">Hurlant; 5ft splash; 1d6 acid dmg per rd; 2p4 rds</td>
            </tr>
            <tr>
                <td style="text-align:left;">Alchemist's Fire (flask)</td>
                <td style="text-align:right;">100sp</td>
                <td style="text-align:center;">1</td>
                <td style="text-align:left;">Hurlant; 5ft splash; 1d8 fire dmg per rd; 2p6 rds</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="text-align:right;">100sp</td>
                <td style="text-align:center;">1</td>
                <td style="text-align:left;"> <strong>Adv</strong> on <strong>Fortitude saves</strong> and <strong>CON Checks</strong> vs poison.</td>
            </tr>
            <tr>
                <td style="text-align:left;">Backpack</td>
                <td style="text-align:right;">4sp</td>
                <td style="text-align:center;">*</td>
                <td style="text-align:left;">Allows wearer to have <strong>Stashed Items</strong>.</td>
            </tr>
            <tr style="background-color:#91a3b0;">
            ...
            <tr style="background-color:#91a3b0;">
                ...
                <td style="text-align:right;">50sp</td>
                <td style="text-align:center;">1</td>
                <td style="text-align:left;">Grants <strong>Adv</strong> on <strong>Lore</strong> checks for one specific subject.</td>
            </tr>
            <tr style="background-color:#91a3b0;">
                <td style="text-align:left;">Caltrops (1 bag)</td>
                <td style="text-align:right;">2sp</td>
                <td style="text-align:center;">1</td>
                <td style="text-align:left;">Covers a 10ft area creating <strong>Difficult Terrain</strong> and does 1d4 piercing dmg on a failed  <strong>Reflex save</strong> vs difficulty 12.</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="text-align:right;">10sp</td>
                <td style="text-align:center;">2</td>
                <td style="text-align:left;">Can hold up to 10 <strong>items</strong>.</td>
            </tr>
            <tr>
                <td style="text-align:left;">Chest, Large</td>
                <td style="text-align:right;">100sp</td>
                <td style="text-align:center;">4</td>
                <td style="text-align:left;">Can hold up to 30 <strong>items</strong>.</td>
            </tr>
            <tr style="background-color:#91a3b0;">
            ...
            <tr>
                ...
                <td style="text-align:right;">10sp</td>
                <td style="text-align:center;">1</td>
                <td style="text-align:left;">Grants <strong>Adv</strong> on STR Checks if leverage applies. May be used as an improvised weapon doing 1d6 blunt dmg at -1 to hit.</td>
            </tr>
            <tr>
            ...
            <tr style="background-color:#91a3b0;">
                ...
                <td style="text-align:right;">2sp</td>
                <td style="text-align:center;">1</td>
                <td style="text-align:left;">May be used as an improvised weapon doing 1d4 blunt dmg at -1 to hit</td>
            </tr>
            <tr style="background-color:#91a3b0;">
                <td style="text-align:left;">Hammer, Sledge</td>
                <td style="text-align:right;">4sp</td>
                <td style="text-align:center;">1</td>
                <td style="text-align:left;">May be used as an improvised weapon doing 1d8 blunt dmg at -1 to hit; 2 hands</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="text-align:right;">50sp</td>
                <td style="text-align:center;">1</td>
                <td style="text-align:left;">Hurlant; 5ft splash; 1d6 radiant dmg to targets vulnerable to radiant dmg.</td>
            </tr>
            <tr style="background-color:#91a3b0;">
            ...
            <tr>
                ...
                <td style="text-align:right;">10sp</td>
                <td style="text-align:center;">1</td>
                <td style="text-align:left;">30ft bright light plus 30ft dim light for 1 <strong>Watch</strong>.</td>
            </tr>
            <tr>
                <td style="text-align:left;">Lock</td>
                <td style="text-align:right;">20sp</td>
                <td style="text-align:center;">@</td>
                <td style="text-align:left;">diff 15 to pick or diff 18 to break.</td>
            </tr>
            <tr>
            ...
            <tr style="background-color:#91a3b0;">
                ...
                <td style="text-align:right;">200sp</td>
                <td style="text-align:center;">1</td>
                <td style="text-align:left;">Victim must make a difficulty 15 <strong>Fortitude save</strong> or become <strong>Poisoned</strong> for 3p6 rounds and takes 1d6 poison damage per round.</td>
            </tr>
            <tr>
            ...
            <tr style="background-color:#91a3b0;">
                ...
                <td style="text-align:center;">2</td>
                <td style="text-align:left;"><strong>Bundle</strong> of 7 days' rations.</td>
            </tr>
            <tr style="background-color:#91a3b0;">
            ...
            <tr style="background-color:#91a3b0;">
                ...
                <td style="text-align:right;">1sp</td>
                <td style="text-align:center;">1</td>
                <td style="text-align:left;">Holds 10 slots worth of gear but takes up 1 hand.</td>
            </tr>
            <tr>
                <td style="text-align:left;">Shovel</td>
                <td style="text-align:right;">4sp</td>
                <td style="text-align:center;">1</td>
                <td style="text-align:left;">May be used as an improvised club doing 1d6 blunt dmg at -1 to hit.</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="text-align:right;">5sp</td>
                <td style="text-align:center;">@</td>
                <td style="text-align:left;">Difficulty 15 <strong>Perception</strong> to spot.</td>
            </tr>
            <tr style="background-color:#91a3b0;">
            ...
            <tr>
                ...
                <td style="text-align:center;">1</td>
                <td style="text-align:left;">20ft bright and 20ft dim light for 1 hour; can be used as an improvised club doing 1d6 fire damage at -1 to hit.</td>
            </tr>
            <tr style="background-color:#91a3b0;">
            ...
            <tr style="background-color:#708090;">
	            <td colspan=4>* When worn, takes up 0 slots; when carried, takes up 1.<br/># Only takes up slots in groups of 100 or more.<br/>@ Only takes up slots in groups of 10 or more.<br/><b>Splash</b> - Affects everyone within the given radius.</td>
            </tr>
        </tbody>
    </table>
</div>  
    ...
    <table border=2>
        ...
        <tbody>
            <tr>
                ...
                <td style="text-align:right;">20sp</td>
                <td style="text-align:left;">backpack, bedroll, heavy cloak, practical clothing, mess kit, rations (1 week), rope (50 ft), tinderbox, torches (bundle) and dagger</td>
            </tr>
            <tr style="background-color:#91a3b0;">
                <td style="text-align:left;">Archer's Pack</td>
                <td style="text-align:right;">120sp</td>
                <td style="text-align:left;">shortbow, arrows (20), medium weapons (2), hardened leather armor</td>
            </tr>
            <tr>
                <td style="text-align:left;">Hoplite's Pack</td>
                <td style="text-align:right;">120sp</td>
                <td style="text-align:left;">medium weapon, shield, ringmail armor</td>
            </tr>
            <tr style="background-color:#91a3b0;">
                <td style="text-align:left;">Mage's Pack</td>
                <td style="text-align:right;">120sp</td>
                <td style="text-align:left;">candles (5), ink (vial), quills (10), spellbook, and a magic focus or holy symbol</td>
            </tr>
            <tr>
                <td style="text-align:left;">Rogue's Pack</td>
                <td style="text-align:right;">70sp</td>
                <td style="text-align:left;">caltrops (bag), candles (5), crowbar, lockpicks, sack, medium weapon, light weapon and leather armor</td>
            </tr>
            <tr style="background-color:#91a3b0;">
                <td style="text-align:left;">Skirmisher's Pack</td>
                <td style="text-align:right;">110sp</td>
                <td style="text-align:left;">candles (5), crowbar, lockpicks, medium weapon, light weapon, javelins (6), buckler, hardened leather armor</td>
            </tr>
            <tr>
                <td style="text-align:left;">Spellblade's Pack</td>
                <td style="text-align:right;">120sp</td>
                <td style="text-align:left;">ink (vial), leather armor, magic focus or holy symbol, medium weapon, quills (10), buckler, spellbook (small)</td>
            </tr>
            <tr style="background-color:#91a3b0;">
                <td style="text-align:left;">Trickster's Pack</td>
                <td style="text-align:right;">120sp</td>
                <td style="text-align:left;">candles (5), ink (vial), leather armor, lockpicks, magic focus or holy symbol, medium weapon, quills (10), sack, spellbook (small)</td>
            </tr>
            <tr>
...
See the [Hirelings and Allies](Hirelings_and_Allies.md) rules for additional notes on the hiring process.
...
<div id="content">
    <table border=2>
        ...
        <tbody>
            ...
            <tr style="background-color:#91a3b0;">
                <td style="text-align:left;"><em>Hirelings</em></td>
                <td style="text-align:right;"></td>
                <td style="text-align:left;">price is per day</td>
            </tr>
            <tr style="background-color:#91a3b0;">
            ...
            <tr style="background-color:#91a3b0;">
                <td style="text-align:left;">-Animal Handler</td>
                <td style="text-align:right;">5sp</td>
                <td style="text-align:left;"></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="text-align:right;">5sp</td>
                <td style="text-align:left;">Additional material costs may apply.</td>
            </tr>
            <tr style="background-color:#91a3b0;">
            ...
            <tr style="background-color:#91a3b0;">
                ...
                <td style="text-align:right;">2sp</td>
                <td style="text-align:left;">equipped with spear, dagger and leather armor</td>
            </tr>
            <tr style="background-color:#91a3b0;">
                <td style="text-align:left;">-Mercenary Sgt</td>
                <td style="text-align:right;">10sp</td>
                <td style="text-align:left;">Required per 10 mercenaries.  Equipped with spear, short sword, shield and ringmail.</td>
            </tr>
            <tr>
                <td style="text-align:left;">-Mercenary Cpt</td>
                <td style="text-align:right;">50sp</td>
                <td style="text-align:left;">Required per 100 mercenaries.  Equipped with arming sword, shield and chainmail.</td>
            </tr>
            <tr>
            ...
            <tr style="background-color:#91a3b0;">
                ...
                <td style="text-align:right;">100sp</td>
                <td style="text-align:left;">per question</td>
            </tr>
            <tr style="background-color:#91a3b0;">
            ...
            <tr style="background-color:#91a3b0;">
                <td style="text-align:left;">-Sailor, Navigator</td>
                <td style="text-align:right;">5sp</td>
                <td style="text-align:left;"></td>
            </tr>
            <tr>
                <td style="text-align:left;">-Sailor, 1st Mate</td>
                <td style="text-align:right;">5sp</td>
                <td style="text-align:left;">Required per 10 sailors.</td>
            </tr>
            <tr>
                <td style="text-align:left;">-Sailor, Cpt</td>
                <td style="text-align:right;">25sp</td>
                <td style="text-align:left;">Required per 100 sailors.</td>
            </tr>
            <tr>
            ...
            <tr style="background-color:#91a3b0;">
                <td style="text-align:left;">-Smith / Crafter</td>
                <td style="text-align:right;">5sp</td>
                <td style="text-align:left;">Additional material costs may apply.</td>
            </tr>
            <tr style="background-color:#91a3b0;">
                <td style="text-align:left;">-Unskilled Labor</td>
                <td style="text-align:right;">1sp</td>
                <td style="text-align:left;"></td>
            </tr>
            <tr>
            ...
            <tr style="background-color:#708090;">
	            <td colspan=3>Costs may double for hazardous / wartime duty.  Even then, most hirelings are unwilling to venture into obviously suicidal situations (like venturing into dungeons or dragon lairs.)</td>
            </tr>
        </tbody>
    </table>
</div>
...
<div id="content">
    <table border=2>
        <thead>
            <tr style="background-color:#708090;">
                <th id="animal" style="text-align:left;">Animal</th>
                <th id="cost" style="text-align:right;">Cost</th>
                <th id="speed" style="text-align:center;">Speed</th>
                <th id="notes" style="text-align:left;">Notes</th>
            </tr>
        </thead>
        <tbody>
...
<div id="content">
    <table border=2>
        ...
        <tbody>
            <tr style="background-color:#91a3b0;">
                <td style="text-align:left;"><em>Barding</em></td>
            ...
            <tr style="background-color:#91a3b0;">
                ...
                <td style="text-align:right;">x0.5</td>
                <td style="text-align:center;">x0.5</td>
                <td style="text-align:left;"/>
            </tr>
            <tr style="background-color:#91a3b0;">
                <td style="text-align:left;">-Medium</td>
                <td style="text-align:right;">x1.0</td>
                <td style="text-align:center;">x1.0</td>
                <td style="text-align:left;"/>
            </tr>
            <tr style="background-color:#91a3b0;">
                <td style="text-align:left;">-Large</td>
                <td style="text-align:right;">x4.0</td>
                <td style="text-align:center;">x2.0</td>
                <td style="text-align:left;"/>
            </tr>
            <tr style="background-color:#91a3b0;">
                <td style="text-align:left;">-Huge</td>
                <td style="text-align:right;">x8.0</td>
                <td style="text-align:center;">x4.0</td>
                <td style="text-align:left;"/>
            </tr>
            <tr>
                <td style="text-align:left;">Bit &amp; Bridle</td>
                <td style="text-align:right;">4sp</td>
                <td style="text-align:center;">@</td>
                <td style="text-align:left;">Disadvantage on mount control checks without this.</td>
            </tr>
            <tr>
                <td style="text-align:left;">Feed (dialy)</td>
                <td style="text-align:right;">1cp</td>
                <td style="text-align:center;">2</td>
                <td style="text-align:left;"/>
            </tr>
            <tr style="background-color:#91a3b0;">
                <td style="text-align:left;"><em>Saddle</em></td>
                <td style="text-align:right;"/>
                <td style="text-align:center;"/>
                <td style="text-align:left;">Disadvantage on riding checks without this.</td>
            </tr>
            <tr style="background-color:#91a3b0;">
                <td style="text-align:left;">-Exotic</td>
                <td style="text-align:right;">120sp</td>
                <td style="text-align:center;">8</td>
                <td style="text-align:left;">Required for aquatic or flying mounts.</td>
            </tr>
            <tr style="background-color:#91a3b0;">
                <td style="text-align:left;">-Military</td>
                <td style="text-align:right;">40sp</td>
                <td style="text-align:center;">6</td>
                <td style="text-align:left;">Grants Advantage on checks to remain mounted.</td>
            </tr>
            <tr style="background-color:#91a3b0;">
                <td style="text-align:left;">-Pack</td>
                <td style="text-align:right;">10sp</td>
                <td style="text-align:center;">3</td>
                <td style="text-align:left;">Increases carry capacity by 20%.</td>
            </tr>
            <tr style="background-color:#91a3b0;">
                <td style="text-align:left;">-Riding</td>
                <td style="text-align:right;">20sp</td>
                <td style="text-align:center;">5</td>
                <td style="text-align:left;"/>
            </tr>
            <tr>
                <td style="text-align:left;">Saddlebags</td>
                <td style="text-align:right;">8sp</td>
                <td style="text-align:center;">2</td>
                <td style="text-align:left;">Increase carry capacity by 10%.</td>
            </tr>
            <tr>
                <td style="text-align:left;">Stabling (daily)</td>
                <td style="text-align:right;">1sp</td>
                <td style="text-align:center;">--</td>
                <td style="text-align:left;">Includes straw to eat, access to the water trough and a brush down by a stable hand.</td>
            </tr>
            <tr style="background-color:#708090;">
                <td colspan=4>@ No encumbrance when worn.  Encumbrance 1 otherwise.</td>
            </tr>
        </tbody>
    </table>
</div>
...
Load is the amount of *Items* the vehicle can carry.
...
<div id="content">
    <table border=2>
        <thead>
            <tr style="background-color:#708090;">
                <th id="vehicle" style="text-align:left;">Vehicle</th>
                <th id="cost" style="text-align:right;">Cost</th>
                <th id="speed" style="text-align:center;">Speed</th>
                <th id="min_animals" style="text-align:left;">Min Animals</th>
                <th id="load" style="text-align:left;">Load</th>
            </tr>
        </thead>
        <tbody>
            <tr>
                <td style="text-align:left;">Carriage</td>
                <td style="text-align:right;">500sp</td>
                <td style="text-align:center;">30</td>
                <td style="text-align:left;">1 draft horse<br/>or 2 mules</td>
                <td style="text-align:left;">4 passengers plus 80 slots</td>
            </tr>
            <tr style="background-color:#91a3b0;">
                ...
                <td style="text-align:center;">30</td>
                <td style="text-align:left;">1 draft horse<br/>or 2 mules</td>
                <td style="text-align:left;">100 slots</td>
            </tr>
            <tr>
                <td style="text-align:left;">Chariot</td>
                <td style="text-align:right;">300sp</td>
                <td style="text-align:center;">40</td>
                <td style="text-align:left;">1 riding horse</td>
                <td style="text-align:left;">1 passenger plus 20 slots</td>
            </tr>
            <tr style="background-color:#91a3b0;">
                <td style="text-align:left;">Wagon</td>
                <td style="text-align:right;">200sp</td>
                <td style="text-align:center;">30</td>
                <td style="text-align:left;">2 draft horses<br/>or 4 mules</td>
                <td style="text-align:left;">200 slots</td>
            </tr>
            <tr style="background-color:#708090;">
                <td colspan=5>These vehicles may not traverse difficult terrain except by well-maintained roads.</td>
            </tr>
        </tbody>
    </table>
</div>
...
A **Squalid** lifestyle basically means the character is homeless and penniless.  Others, even others living in squalid conditions, will look down on your filthy hygiene and ragged appearance.  As a result you have *Disadvantage* on all [social checks](Glossary.md#social%20check).  Additionally, you must pass at difficulty 15 Constitution Check to recover any levels of [Exhaustion](Conditions.md#exhausted).

A **Poor** lifestyle is one of labor and hardship as you struggle to keep food on the table and a roof over your head.  The hard work of this lifestyle means you need to pass a difficulty 12 Constitution Check to recover any levels of [Exhaustion](Conditions.md#exhausted).
    ...
    <table border=2>
        ...
        <tbody>
            <tr>
                ...
                <td style="text-align:left;">Disadvantage on social checks.  Must pass a diff 15 CON Check to recover Exhaustion.</td>
            </tr>
            <tr style="background-color:#91a3b0;">
                <td style="text-align:left;">Poor</td>
                <td style="text-align:right;">2cp</td>
                <td style="text-align:left;">Must pass a diff 12 CON Check to recover Exhaustion.</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="text-align:right;">20sp</td>
                <td style="text-align:left;">Roll +1 HD when healing.  Advantage on social checks.</td>
            </tr>
            <tr style="background-color:#708090;">
                <td colspan=3>Costs on the above table are per day.</td>
            </tr>
        </tbody>
    </table>
</div>